...
export const STATIC_SOLANA_TOKENS = [
    ...
    { symbol: 'WBTC', name: 'Wrapped Bitcoin', mint: '3NZ9JMVBmGAqocybic2cjwLQkzFxDwRhDBq2cXKYLbme', decimals: 8, cmcRankHint: 1 },
    { symbol: 'WETH', name: 'Wrapped Ether', mint: '7vfCXTUXx5WJV5JADk17DUJ4ksgau7utNKj4b963voxs', decimals: 8, cmcRankHint: 2 },
    ...
    { symbol: 'W', name: 'Wormhole', mint: '85VBFQZC9TZkfaptBWjvUwDYMKZSAfvAb5BK7BqmHUQw', decimals: 6 },
...
export function staticMintForSymbol(symbol) {
    return BY_SYMBOL.get(symbol.toUpperCase());
}
export function staticTokenForMint(mint) {
