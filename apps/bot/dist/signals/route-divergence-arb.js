...
export class RouteDivergenceArbStrategy {
    ...
    evaluate(state, ctx) {
        ...
        for (const construction of div.constructions) {
            ...
            const freshness = evaluateQuoteFreshness(construction.forward.capturedAtMs, construction.reverse.capturedAtMs, construction.forward.response, construction.reverse.response, state.timestampMs);
